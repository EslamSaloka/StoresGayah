                ...
                <div class="col-lg-6 col-md-8">
                    <div class="inner">
                        <ul class="axil-breadcrumb">
                            ...
                            <li class="axil-breadcrumb-item active" aria-current="page">التحقق من رقم الجوال</li>
                        </ul>
                        <h1 class="title">التحقق من رقم الجوال</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6 offset-xl-4">
                    <div class="axil-signin-form-wrap">
                        <div class="axil-signin-form">
                            ...
                            <p class="b2 mb--55">اكتب كود التحقق المرسل على رقم جوالك</p>
                            <form class="singin-form SendDataForm" action="{{ makeRoute('otp.store') }}">
                                @csrf
                                <div class="form-group">
                                    <label>كود التحقق</label>
                                    <input type="text" class="form-control inputD" name="otp" placeholder="XXXX">
                                </div>
                                <div class="form-group">
